...
import (
	...
	awssecretsmanagerv1alpha1 "github.com/nholuongut/aws-secrets-manager-k8s/pkg/apis/awssecretsmanager/v1alpha1"
	hash "github.com/nholuongut/aws-secrets-manager-k8s/pkg/util/hash"
...
// +kubebuilder:rbac:groups=awssecretsmanager.nholuongut.net,resources=syncs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=awssecretsmanager.nholuongut.net,resources=syncs/status,verbs=get;update;patch
